...
class SimuladorOSI:
    ...
    def _construir_ui(self):
        ...
        self.entrada.insert(0, "Ingrese mensaje a transmitir ")
        ...
        self._construir_terminal("a", 0, "PC-A EMISOR (ENCAPSULAMIENTO L7→L1)")
        self._construir_canal()
        self._construir_terminal("b", 2, "PC-B RECEPTOR (DESENCAPSULAMIENTO L1→L7)")
    ...
    def transmitir(self):
        ...
        if not msg:
            messagebox.showwarning("Campo vacío", " Por favor ingresa un mensaje antes de enviar.")
            return
        if self._animando:
            return
